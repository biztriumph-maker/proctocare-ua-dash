    ...
    <div className="flex h-[50px] gap-2 bg-transparent border-0">
        ...
        className={cn(
          ...
          disabledOperational
            ...
            : activeView === "operational"
              ? "border-brand-active bg-brand-active text-white shadow-[0_2px_8px_rgba(0,51,102,0.15)] active:scale-[0.97]"
      ...
      <button
        ...
        className={cn(
          ...
          activeView === "calendar"
            ? "border-brand-active bg-brand-active text-white shadow-[0_2px_8px_rgba(0,51,102,0.15)]"
